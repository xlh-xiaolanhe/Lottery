...
public class ActivityTest {
    ...
    public void init(){
        ...
        activity.setState(Constants.ActivityStateEnum.EDIT.getCode());
        ...
        strategy.setStrategyMode(Constants.StrategyModeEnum.SINGLE.getCode());
    ...
    public void test_createActivity() {
        activityDeploy.createActivity(new ActivityConfigRequest(activityId, activityConfigRich));
    }

    @Test
    public void test_alterState() {
        logger.info("提交审核，测试：{}", JSON.toJSONString(stateHandler.arraignment(100001L, Constants.ActivityStateEnum.EDIT)));
        logger.info("审核通过，测试：{}", JSON.toJSONString(stateHandler.checkPass(100001L, Constants.ActivityStateEnum.ARRAIGNMENT)));
        logger.info("运行活动，测试：{}", JSON.toJSONString(stateHandler.doing(100001L, Constants.ActivityStateEnum.PASS)));
        logger.info("二次提审，测试：{}", JSON.toJSONString(stateHandler.checkPass(100001L, Constants.ActivityStateEnum.EDIT)));
    }
}
